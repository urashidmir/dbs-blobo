package uk.co.digitalbrainswitch.dbsblobodiary.bluetooth;
...
public class BluetoothChatService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        //was connected send an A to begin
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    bytes = mmInStream.read(buffer, 0, BUFFER_SIZE-1);
                    ...
                    //was blobo connected send an A to MAINTAIN CONENCTION
                    /*
                    byte[] send = "A".getBytes();
                    write(send);
                    */
